...
VALUES
('global','global','smpp.canonical-telemetry-fact',1,'smpp.providerops/v1.1','candidate','{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":true,"x-sdar-status":"pending-runtime-freeze"}',lower(hex(SHA256('{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":true,"x-sdar-status":"pending-runtime-freeze"}'))),1,'SMPP canonical ProviderOps fact source contract.'),
('global','global','smpp.entity-relation-fact',1,'smpp.providerops/v1.1','candidate','{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":true,"x-sdar-status":"pending-runtime-freeze"}',lower(hex(SHA256('{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":true,"x-sdar-status":"pending-runtime-freeze"}'))),1,'SMPP entity relation source contract.'),
('global','global','sdar.external-provider-fact',1,'sdar.telemetry/v1','candidate','{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":true,"x-sdar-status":"pending-runtime-freeze"}',lower(hex(SHA256('{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":true,"x-sdar-status":"pending-runtime-freeze"}'))),1,'SDAR external ProviderOps target fact.'),
('global','global','sdar.external-entity-relation-fact',1,'sdar.telemetry/v1','candidate','{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":true,"x-sdar-status":"pending-runtime-freeze"}',lower(hex(SHA256('{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":true,"x-sdar-status":"pending-runtime-freeze"}'))),1,'SDAR external entity relation target fact.');

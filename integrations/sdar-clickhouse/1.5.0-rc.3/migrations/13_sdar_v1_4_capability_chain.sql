...
VALUES
('global','global','sdar.node-capability-version-fact',1,'sdar.node-control/v1','candidate','{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":true,"x-sdar-status":"pending-runtime-freeze"}',lower(hex(SHA256('{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":true,"x-sdar-status":"pending-runtime-freeze"}'))),1,'Node Capability version projection.'),
('global','global','sdar.capability-implementation-binding-fact',1,'sdar.node-control/v1','candidate','{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":true,"x-sdar-status":"pending-runtime-freeze"}',lower(hex(SHA256('{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":true,"x-sdar-status":"pending-runtime-freeze"}'))),1,'Capability implementation binding projection.'),
('global','global','sdar.capability-readiness-fact',1,'sdar.evidence/v1','candidate','{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":true,"x-sdar-status":"pending-runtime-freeze"}',lower(hex(SHA256('{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":true,"x-sdar-status":"pending-runtime-freeze"}'))),1,'Runtime-authoritative Capability readiness projection.'),
('global','global','sdar.a2a-exposure-revision-fact',1,'sdar.node-control/v1','candidate','{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":true,"x-sdar-status":"pending-runtime-freeze"}',lower(hex(SHA256('{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":true,"x-sdar-status":"pending-runtime-freeze"}'))),1,'A2A Exposure revision projection.'),
('global','global','sdar.agent-card-revision-fact',1,'sdar.node-control/v1','candidate','{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":true,"x-sdar-status":"pending-runtime-freeze"}',lower(hex(SHA256('{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":true,"x-sdar-status":"pending-runtime-freeze"}'))),1,'Applied Agent Card revision projection.'),
('global','global','sdar.task-capability-binding-fact',1,'sdar.evidence/v1','candidate','{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":true,"x-sdar-status":"pending-runtime-freeze"}',lower(hex(SHA256('{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":true,"x-sdar-status":"pending-runtime-freeze"}'))),1,'Immutable Task Capability contract projection.'),
('global','global','sdar.task-capability-attempt-fact',1,'sdar.evidence/v1','candidate','{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":true,"x-sdar-status":"pending-runtime-freeze"}',lower(hex(SHA256('{"$schema":"https://json-schema.org/draft/2020-12/schema","type":"object","additionalProperties":true,"x-sdar-status":"pending-runtime-freeze"}'))),1,'Task Capability implementation attempt projection.');

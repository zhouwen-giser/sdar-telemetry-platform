...
- SDAR Telemetry SHA: pending phase commit (parent `3f6e5a4`)
...
- Blockers/resume point: live rows from the companion projection remain required for S8 and G-SMPP-26.

...
| Item | Value |
| --- | --- |
| Phase state | `PHASE_2_PUBLISHED_PHASE_3_IN_PROGRESS` |
...
| Phase 3 — durable source ingestion | IN_PROGRESS | authenticated routes, fsync-before-ACK, allowlisted ClickHouse routing |
...
Resume at Phase 3 durable Domain Source ingestion and WAL routing. Keep all projections disabled

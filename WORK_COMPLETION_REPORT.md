...
| Phase 5 | in progress — DomainProjectionRegistry, identity and common target envelope |
| Phases 6–17 | not yet complete |
...
Current status: `IN_PROGRESS_CONTROL_POSTGRES_VERIFIED_PROJECTIONS_DISABLED`.
